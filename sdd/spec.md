...
Este projeto prova que: processamento streaming.

## Stack

java21, kafka-streams, redpanda, testcontainers, docker

## User-visible output

- Docker command: pending
- README opens with: # #28 kafka-streams-demo
- Benchmark table: messages_per_second
