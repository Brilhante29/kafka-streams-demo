...
- Publication-state P1: 1 open until evidence is committed and GitHub Actions is observed green.
...
| P1 | Release evidence and remote CI were not yet published. | Clean baseline/SBOM now exist locally. Final resolution requires evidence commit, PR, and observed green CI. | open |
